  ...
  return (
    <section style={{ background: 'var(--cream)', padding: 'clamp(32px, 5vw, 56px) clamp(20px, 5vw, 80px)' }}>
      <div style={{ border: '1px solid var(--gold)', background: 'var(--black)', padding: 'clamp(40px, 5vw, 64px) clamp(24px, 4vw, 56px)', maxWidth: '1200px', margin: '0 auto', textAlign: 'center' }}>
        ...
        <p className="descuentos-label" style={{ fontSize: '14px', color: 'var(--cream)', marginTop: '16px', fontFamily: 'Jost, sans-serif', fontWeight: '300' }}>
          Los descuentos se aplican automáticamente<span className="descuentos-extra"> al agregar viandas al carrito</span>.
        </p>
      </div>
    </section>
  )
